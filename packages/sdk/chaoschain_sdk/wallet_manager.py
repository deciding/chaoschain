...
class WalletManager:
    ...
    def _initialize_web3_connection(self):
        ...
        rpc_urls = {
            NetworkConfig.ETHEREUM_MAINNET: os.getenv(
                "ETH_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.ETHEREUM_MAINNET]
            ),
            NetworkConfig.BASE_MAINNET: os.getenv(
                "BASE_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.BASE_MAINNET]
            ),
            NetworkConfig.POLYGON_MAINNET: os.getenv(
                "POLYGON_MAINNET_RPC_URL",
                default_rpc_urls[NetworkConfig.POLYGON_MAINNET],
            ),
            NetworkConfig.ARBITRUM_MAINNET: os.getenv(
                "ARBITRUM_MAINNET_RPC_URL",
                default_rpc_urls[NetworkConfig.ARBITRUM_MAINNET],
            ),
            NetworkConfig.CELO_MAINNET: os.getenv(
                "CELO_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.CELO_MAINNET]
            ),
            NetworkConfig.GNOSIS_MAINNET: os.getenv(
                "GNOSIS_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.GNOSIS_MAINNET]
            ),
            NetworkConfig.SCROLL_MAINNET: os.getenv(
                "SCROLL_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.SCROLL_MAINNET]
            ),
            NetworkConfig.TAIKO_MAINNET: os.getenv(
                "TAIKO_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.TAIKO_MAINNET]
            ),
            NetworkConfig.MONAD_MAINNET: os.getenv(
                "MONAD_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.MONAD_MAINNET]
            ),
            NetworkConfig.BSC_MAINNET: os.getenv(
                "BSC_MAINNET_RPC_URL", default_rpc_urls[NetworkConfig.BSC_MAINNET]
            ),
            NetworkConfig.ETHEREUM_SEPOLIA: os.getenv(
                "SEPOLIA_RPC_URL", default_rpc_urls[NetworkConfig.ETHEREUM_SEPOLIA]
            ),
            NetworkConfig.BASE_SEPOLIA: os.getenv(
                "BASE_SEPOLIA_RPC_URL", default_rpc_urls[NetworkConfig.BASE_SEPOLIA]
            ),
            NetworkConfig.POLYGON_AMOY: os.getenv(
                "POLYGON_AMOY_RPC_URL", default_rpc_urls[NetworkConfig.POLYGON_AMOY]
            ),
            NetworkConfig.ARBITRUM_TESTNET: os.getenv(
                "ARBITRUM_TESTNET_RPC_URL",
                default_rpc_urls[NetworkConfig.ARBITRUM_TESTNET],
            ),
            NetworkConfig.CELO_TESTNET: os.getenv(
                "CELO_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.CELO_TESTNET]
            ),
            NetworkConfig.SCROLL_TESTNET: os.getenv(
                "SCROLL_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.SCROLL_TESTNET]
            ),
            NetworkConfig.MONAD_TESTNET: os.getenv(
                "MONAD_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.MONAD_TESTNET]
            ),
            NetworkConfig.BSC_TESTNET: os.getenv(
                "BSC_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.BSC_TESTNET]
            ),
            NetworkConfig.OPTIMISM_SEPOLIA: os.getenv(
                "OPTIMISM_SEPOLIA_RPC_URL",
                default_rpc_urls[NetworkConfig.OPTIMISM_SEPOLIA],
            ),
            NetworkConfig.LINEA_SEPOLIA: os.getenv(
                "LINEA_SEPOLIA_RPC_URL", default_rpc_urls[NetworkConfig.LINEA_SEPOLIA]
            ),
            NetworkConfig.MODE_TESTNET: os.getenv(
                "MODE_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.MODE_TESTNET]
            ),
            NetworkConfig.ZEROG_TESTNET: os.getenv(
                "ZEROG_TESTNET_RPC_URL", default_rpc_urls[NetworkConfig.ZEROG_TESTNET]
            ),
            NetworkConfig.LOCAL: os.getenv(
                "LOCAL_RPC_URL", default_rpc_urls[NetworkConfig.LOCAL]
            ),
        }
        ...
        try:
            ...
            try:
                ...
                raise NetworkError(
                    f"Failed to connect to {self.network} at {rpc_url}: {str(conn_err)}"
                )
        except NetworkError:
            raise
